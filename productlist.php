...
<html>
  ...
  <head>
    <title> Explore | IMAZMIM Care </title>
  </head>
...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active" ><a href="productlist.php"><span class="glyphicon glyphicon-tags"></span> Healthy Zone </a></li>
...
<h5 class="text-danger">&#127474;&#127486; <?php echo $row["price"]; ?> RM</h5>
...
else
{
  ...
  <div class="container">
    <div class="jumbotron">
      <center>
         <label style="margin-left: 5px;color: red;"> <h1>Oops! No product is available.</h1> </label>
        <p>Waiting to be Healthy...! :P</p>
      </center>
