...
<html>
  ...
  <head>
    <title> Contact | IMAZMIM Care </title>
  </head>
...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="productlist.php"><span class="glyphicon glyphicon-cutlery"></span> Healthy Zone </a></li>
...
?>
    ...
    <div class="heading">
     <strong>Want to contact <span class="edit"> IMAZMIM Care</span>?</strong>
     <br>
